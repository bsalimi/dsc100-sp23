...
|     | April 27        | Formal Relational Query Languages Part 1 | This lecture will introduce the basics of relational algebra, extended relational algebra, and their connection to data frames and SQL.  |**Homework 3 - release:** Advanced SQL and PostgreSQL | | | | Understanding Formal Relational languages, such as relational algebra, is crucial for understanding how relational database systems operate. |
...
|       | May 4    |  Interactive Data Analysis Using SQL |   | **Homework 4 - release:** Relational Algebra | |  | | 
